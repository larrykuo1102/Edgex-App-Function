...
2. Change name `azure-iot` in go.mod file to an appropriate Go Module name for your service

   - Typically this is the URL to the repository for your service

3. Remove the `replace` statement from the go.mod file

4. Do a global search and replace on `azure-iot` to replace it with the name of your service
